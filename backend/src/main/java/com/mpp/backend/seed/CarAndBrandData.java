...
import com.mpp.backend.services.CarService;
...
public class CarAndBrandData {
    ...
    Stack<String> images = new Stack<>(){{
        ...
        add("https://cdn.autoportal.com/img/new-cars-gallery/lamborghini/aventador/exterior/0056867/lamborghini-aventador-0056867-500x375.jpg");
        add("https://imgd.aeplcdn.com/642x361/n/cw/ec/44112/hyundai-aura-exterior-5.jpeg?q=75");
